...
namespace antlr4
{
	...
	public:
		 ...
		 */
		virtual std::vector<std::string_view> const& getTokenNames() const = 0;
		virtual std::vector<std::string_view> const& getRuleNames() const = 0;
	...
	private:
		...
		static std::map<std::vector<std::string_view>, std::map<std::string, size_t>> _ruleIndexMapCache;
