...
namespace antlr4 {
	...
	public:
		...
		virtual Token* match(size_t ttype, ParserRuleContext* currentContext);
		...
		/// symbol </exception>
		virtual Token* matchWildcard(ParserRuleContext* currentContext);
		...
		/// </summary>
		/// <seealso cref= #addParseListener </seealso>
		virtual void triggerEnterRuleEvent(ParserRuleContext* currentContext);

		/// <summary>
		/// Notify any parse listeners of an exit rule event.
		/// </summary>
		/// <seealso cref= #addParseListener </seealso>
		virtual void triggerExitRuleEvent(ParserRuleContext* currentContext);
		...
		/// listeners.
		virtual Token* consume(ParserRuleContext* currentContext);

		/// Always called by generated parsers upon entry to a rule. Access field
		/// <seealso cref="#_ctx"/> get the current context.
		virtual void enterRule(std::unique_ptr<ParserRuleContext>&& currentContext, size_t state, size_t ruleIndex);

		void exitRule(ParserRuleContext* currentContext);
		...
		/// </summary>
		virtual std::vector<std::string> getRuleInvocationStack(ParserRuleContext* current);

		virtual std::vector<std::string_view> getRuleInvocationStack(RuleContext* p);
		...
		/** How to create an error node, given a token, associated with a parent.
		   ...
		   * @since 4.7
		   */
		std::unique_ptr<tree::ErrorNode> createErrorNode(Token* t);
