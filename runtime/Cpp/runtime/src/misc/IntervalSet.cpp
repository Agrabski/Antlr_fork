...
std::string IntervalSet::toString(const std::vector<std::string_view>& tokenNames) const {
...
std::string IntervalSet::elementName(const std::vector<std::string_view>& tokenNames, ssize_t a) const {
