...
namespace antlr4 {
	...
	public:
		DefaultErrorStrategy() noexcept;
		DefaultErrorStrategy(DefaultErrorStrategy const& other) = delete;
		virtual ~DefaultErrorStrategy() = default;
	...
	public:
		...
		/// the exception</li>
		/// </ul>
		void reportError(Parser* recognizer, const RecognitionException& e, ParserRuleContext* currentContext) override;
	...
	public:
		 ...
		 */
		Token* recoverInline(Parser* recognizer, ParserRuleContext* currentContext) override;
