...
namespace antlr4 {
	namespace dfa {
		...
		public:
			...
			Vocabulary(const std::vector<std::string_view>& literalNames, const std::vector<std::string_view>& symbolicNames);
			...
			Vocabulary(const std::vector<std::string_view>& literalNames, const std::vector<std::string_view>& symbolicNames,
				const std::vector<std::string_view>& displayNames);
			...
			static Vocabulary fromTokenNames(const std::vector<std::string_view>& tokenNames);
			...
			virtual std::string_view getLiteralName(size_t tokenType) const;
			...
			virtual std::string_view getSymbolicName(size_t tokenType) const;
			...
			virtual std::string_view getDisplayName(size_t tokenType) const;

		private:
			std::vector<std::string_view> const _literalNames;
			std::vector<std::string_view> const _symbolicNames;
			std::vector<std::string_view> const _displayNames;
