...
const std::vector<std::string_view>& XPathLexer::getRuleNames() const
{
	return _ruleNames;
}

const std::vector<std::string_view>& XPathLexer::getChannelNames() const {
	return _channelNames;
}

const std::vector<std::string_view>& XPathLexer::getModeNames() const {
	return _modeNames;
}

const std::vector<std::string_view>& XPathLexer::getTokenNames() const {
	return _tokenNames;
}
...
const std::vector<uint16_t> XPathLexer::getSerializedATN() const noexcept
{
...
std::vector<std::string_view> XPathLexer::_ruleNames = {
  "ANYWHERE", "ROOT", "WILDCARD", "BANG", "ID", "NameChar", "NameStartChar",
  "STRING"
};

std::vector<std::string_view> XPathLexer::_channelNames = {
  "DEFAULT_TOKEN_CHANNEL", "HIDDEN"
};

std::vector<std::string_view> XPathLexer::_modeNames = {
  "DEFAULT_MODE"
};

std::vector<std::string_view> XPathLexer::_literalNames = {
  "", "", "", "'//'", "'/'", "'*'", "'!'"
};

std::vector<std::string_view> XPathLexer::_symbolicNames = {
...
std::vector<std::string_view> XPathLexer::_tokenNames;
